...
public class SqliteInstrumentoRepository : InstrumentoRepository
{
    ...
    public IEnumerable<Domain.Instrumento.Model.Instrumento> SearchByCriteria(Dictionary<string, object> dictionary)
    {
        using (var connection = DbConnection.GetSQLiteConnection())
        {
            ...
            return result.Select(item => new Domain.Instrumento.Model.Instrumento(
    ...
    public Domain.Instrumento.Model.Instrumento SearchById(int id)
    {
        using (var connection = DbConnection.GetSQLiteConnection())
        {
            ...
            return new Domain.Instrumento.Model.Instrumento(
    ...
    public void Insert(Domain.Instrumento.Model.Instrumento newPec660)
    {
        using (var connection = DbConnection.GetSQLiteConnection())
        {
            if (connection == null)
    ...
    public void Update(Domain.Instrumento.Model.Instrumento pec660)
    {
        using (var connection = DbConnection.GetSQLiteConnection())
        {
            if (connection == null)
