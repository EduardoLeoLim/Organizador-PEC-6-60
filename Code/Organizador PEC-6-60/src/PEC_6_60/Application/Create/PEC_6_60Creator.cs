...
namespace Organizador_PEC_6_60.PEC_6_60.Application.Create;

public class PEC_6_60Creator
{
    private readonly PEC_6_60Repository _repository;

    public PEC_6_60Creator(PEC_6_60Repository repository)
    {
        _repository = repository;
    }

    public void Create(PEC_6_60AñoEstadistico añoEstadistico, PEC_6_60MesEstadistico mesEstadistico,
        PEC_6_60Consecutivo consecutivo, byte[] dataArchivo, int idInstrumento, int idTipoEstadistica, int idMunicipio)
    {
